...
@Component({
    moduleId: module.id,
    selector: 'app-game-social-icon',
    templateUrl: './game-social-icon.component.html',
    styleUrls: ['./game-social-icon.component.scss'],
...
export class GameSocialIconComponent implements OnInit {
